...
df1=read_csv('airports.csv')
df2=read_csv('hdi.csv')
df3=read_csv('states.csv')
df4 = read_csv('icu-beds.csv')
df1 <- merge(df1, df2)
df1 <- merge(df1, df3)
df1 <- merge(df1, df4)
df1 <- df1[,-c(7:21,29,30,1)]
```
...
fit2 <- lm(formula = GDP ~ `Passengers rate` + `HDI Education 2017` + 
