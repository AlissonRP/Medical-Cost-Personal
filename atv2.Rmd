...
ft2 <- lm(formula = GDP ~ `Passengers rate` + `HDI Education 2017` + 
    `HDI Wealth 2017` + `HDI Health 2017` + Population + Poverty + `Private beds per citizen`, data = df1)
