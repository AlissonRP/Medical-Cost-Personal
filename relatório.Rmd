...
Neste apêndice serão analisados outros modelos preditivos junto com o regressão linear, como os modelos de florestas aleatórias (rf) e os k-vizinhos mais próximos (knn), que pode ser acessado clicando [aqui](encurtador.com.br/puPS6).
...
O código completo pode ser acessado  [aqui](https://github.com/AlissonRP/gdp-statesBR/blob/main/código.Rmd).
