...
tidy(fit2) %>% 
  ...
  kable_classic(latex_options = "HOLD_position") 
```
Que informa que o intercepto não significativo a 5%. Tem-se um p-valor << 0.001 do teste F e $R^2$ dado por `r round(glance(ft2)[1],3)` que informa que aproximadamente `r round(glance(ft2)[1],3)*100`% da variação do PIB per capita dos estados é explicada pelas covariáveis propostas.
