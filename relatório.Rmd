...
tidy(fit2) %>% 
  ...
  footnote(general = "Na verdade, o valor com maior precisão do p-valor do teste de significância associado a  Pobreza é: 0,0000048 ",footnote_as_chunk = T, title_format = c("italic", "underline")) %>% 
  kable_classic(latex_options = "HOLD_position") 
