...
fit1=df_tuner %>% 
  ...
  fit(df_train)                   # e como a variável sexo foi significativa usaremos o modelo "t"
...
## H0: O modelo estacorretamente especificado
...
abline(plot(dffits(ft2),ylab="DFFITS"), 
       col="red", h=limite,lty=2)
identify(dffits(fit),n=2) # para identificar os pontos
```
```{r cook}
limite<-4/(n-ft2$rank )
